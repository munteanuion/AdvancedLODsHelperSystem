...
#pragma warning disable
        ...
        private static bool applyForOptionsChange;
...
#pragma warning disable
        ...
        private static Func<bool> CheckOnThreads = new Func<bool>(() => { return (TriangleCount >= 1500 && dataContainer.objectMeshPairs.Count >= 2); });
...
#region Draw custom handles for preservation sphere
        ...
        public static void ManualUpdateMeshOptimizedResult() 
        {
...
#region Title Header
                ...
                if(isPlainSkin)
                {
                    if (GUILayout.Button("<size=14><b>POLY FEW</b></size> <size=7><b>v7.76</b></size>", style)) { toolMainFoldout = !toolMainFoldout; }
                }
                else
                {
                    if (GUILayout.Button("<size=14><color=#A52A2AFF><b>POLY FEW</b></color></size> <size=7><b><color=#A52A2AFF>v7.76</color></b></size>", style)) { toolMainFoldout = !toolMainFoldout; }
                }
